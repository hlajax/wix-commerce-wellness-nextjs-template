...
<section className="bg-green-50 py-20 px-6 text-center">
  <div className="max-w-4xl mx-auto">
    ...
    <p className="text-lg text-green-700 mb-10">
      Découvrez notre gamme de produits naturels soigneusement sélectionnés pour
      améliorer votre santé et votre qualité de vie. Chaque produit est conçu
      pour vous aider à atteindre votre équilibre optimal.
    </p>
    <a
      href="/shop"
